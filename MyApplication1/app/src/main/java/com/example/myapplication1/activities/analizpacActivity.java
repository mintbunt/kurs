            ...
            private void uploadImage(int id, String name){
                class UploadImage extends AsyncTask<Bitmap,Void,String> {
                    ...
                    protected void onPreExecute() {
                        super.onPreExecute();
                        loading = ProgressDialog.show(analizpacActivity.this, "Загружаем изображение", "Подождите...",true,true);
                    }
               ...
               int id1 = intent.getIntExtra("id", 0);
                ...
                if(v == buttonUpload){
                    ...
                    uploadImage(id1, nam);
                        ...
                        Toast.makeText(analizpacActivity.this, "Введите наименование!", Toast.LENGTH_SHORT).show();
                    }
                }
                if(v == buttonView){
